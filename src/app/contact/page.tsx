                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="w-full bg-blue-900 text-white py-4 px-6 rounded-lg font-semibold flex items-center justify-center space-x-2 hover:bg-blue-800 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
                    >
