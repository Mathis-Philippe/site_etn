    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-200 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white shadow-2xl rounded-2xl overflow-hidden z-10 border border-gray-100">
        <div className="pt-10 pb-6 px-8 flex flex-col items-center border-b border-gray-50">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Mot de passe oublié</h1>
          <p className="text-sm text-gray-500 mt-2 font-medium text-center">Entrez votre e-mail pour recevoir un lien sécurisé</p>
        </div>
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {isLoading ? "Envoi en cours..." : "M'envoyer le lien"}
            </button>
          </form>

          {message && (
            <div className="mt-6 p-4 rounded-lg text-sm bg-green-50 text-green-700 border border-green-100 text-center font-medium">
              {message}
            </div>
          )}
